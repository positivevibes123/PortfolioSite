...
<template>
  <div class="flex justify-center">
    <nav class="fixed border border-black bg-white dark:border-white dark:bg-gray-900 rounded-xl max-w-2xl w-full">
    <div
      class="flex flex-wrap justify-center mx-auto p-4"
    >
      <button
